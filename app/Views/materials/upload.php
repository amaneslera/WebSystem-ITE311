...
<div class="container mt-5">
    ...
    <!-- enctype="multipart/form-data" required for file uploads - allows binary file transmission -->
    <form action="<?= base_url('materials/upload/' . $course_id) ?>" method="post" enctype="multipart/form-data" class="card p-4 shadow-sm">
        <div class="mb-3">
            ...
            <div class="form-text">
                <strong>Allowed types:</strong> pdf, doc, docx, ppt, pptx, zip, rar, jpg, jpeg, png<br>
                <strong>Max size:</strong> 10MB<br>
                <small class="text-muted">Files are validated for type and size to ensure security</small>
            </div>
        </div>
